...
<body class="blog-details-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a class="cta-btn" href="index.blades.php#about">Get Started</a>
    ...
    <section id="blog-details" class="blog-details section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="blog-details-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="ragel/ragel/assets/img/blog/app-1.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="ragel/ragel/assets/img/blog/product-1.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="ragel/ragel/assets/img/blog/branding-1.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="ragel/ragel/assets/img/blog/books-1.jpg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="blog-info" data-aos="fade-up" data-aos-delay="200">
