...
<body class="hotel-details-page">
  ...
  <main class="main">
    ...
    <!-- Page Title -->
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(ragel/ragel/assets/img/page-title-bg.webp);">
      <div class="container position-relative">
        <h1>HOTEL</h1>
        <p>Esse dolorum voluptatum ullam est sint nemo et est ipsa porro placeat quibusdam quia assumenda numquam molestias.</p>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.blade.html">Home</a></li>
            <li class="current">HOTEL</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
            <img src="ragel/ragel/assets/img/services.jpg" alt="" class="img-fluid hotel-img">
